...
layui.use(['element', 'jquery', 'form', 'layedit'], function () {
    ...
    form.on('submit(formReply)', function (data) {
        ...
        setTimeout(function () {
            ...
            var html = '<div class="comment-child"><img src="../images/tw.jpg"alt="校团委"/><div class="info"><span class="username">校团委</span><span>' + content + '</span></div><p class="info"><span class="time">2017-05-10 18:26</span></p></div>';
